...
<body
	style="background: #fff url(${pageContext.request.contextPath}/moban/images/grey.jpg);background-size:cover;">
				...
				<!--<form action="touser" autocomplete="on" method="post">
					...
					<p>
						...
						<select class="form-control" name="sex" id="name">
							<option name="男" id="0">男</option>
							<option name="女" id="1">女</option>
						</select>
      ...
      <ul class="ulColumn2">
       ...
       <li>
        ...
        <select class="select"  name="t1">
         ...
         <option name="t1" value="3" >采购人员</option>
        </select>
       </li>
        <li>
       ...
       <li>
        ...
        <input type="submit" class="link_btn" value="注册"/>
       </li>
