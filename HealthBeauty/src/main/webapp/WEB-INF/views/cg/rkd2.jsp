		...
		<ul>
			<li>
				<dl>
					...
					<dd>
						<a href="lookStatus1" class="active">查看审核状态</a>
					</dd>
				</dl>
			</li>
		</ul>
...
<form action="updateHw1" method="post">
...
<input type="hidden" name="isFrame" value="${list.isFrame}">
 ...
 <%--       <li>
        ...
        <input type="text" name="askMoney" value="${list.askMoney }" class="textbox textbox_225"  placeholder="询问价格..."/>
       </li> --%>
